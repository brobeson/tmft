...
import experiments.single_sequence
...
def _parse_command_line() -> argparse.Namespace:
    ...
    :returns: The command line arguments and values.
...
def _main() -> None:
    ...
    if arguments.sequence is not None:
        experiments.single_sequence.run(configuration, arguments.sequence)
        return
...
def _run_multiple_experiments(multi_configuration: dict) -> None:
    ...
    :param dict multi_configurati0n: The configuration that specifies the actual experimental
